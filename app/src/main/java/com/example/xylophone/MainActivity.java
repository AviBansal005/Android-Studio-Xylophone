...
public class MainActivity extends AppCompatActivity {
    ...
    public void playnote1(View view) {
        mSoundPool.play(note1,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote2(View view) {
        mSoundPool.play(note2,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote3(View view) {
        mSoundPool.play(note3,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote4(View view) {
        mSoundPool.play(note4,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote5(View view) {
        mSoundPool.play(note5,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote6(View view) {
        mSoundPool.play(note6,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }

    public void playnote7(View view) {
        mSoundPool.play(note7,LEFT_VOLUME,RIGHT_VOLUME,PRIORITY,LOOP,RATE);
    }
}